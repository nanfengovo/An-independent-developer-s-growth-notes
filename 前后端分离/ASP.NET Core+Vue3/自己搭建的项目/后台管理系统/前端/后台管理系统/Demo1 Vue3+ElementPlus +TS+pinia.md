...
>子组件发生点击改变父组件
### 效果图
![[Pasted image 20250302232513.png]]
![[Pasted image 20250302232523.png]]
### 实现步骤：
...
```
##### 核心代码解析
![[Pasted image 20250302233123.png]]
#### 处理侧边栏宽度
代码：
```
<template>
...
##### 核心代码解析
![[Pasted image 20250302233357.png]]
#### 折叠菜单
```
<template>
...
##### 核心代码解析
![[Pasted image 20250302233623.png]]
![[Pasted image 20250302233640.png]]
...
#### 将路由对象写在独立的文件里
![[Pasted image 20250304213201.png]]
#### 根据菜单动态的添加路由对象
##### 1、获取菜单
