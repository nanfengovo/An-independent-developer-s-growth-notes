...
### 第一步：
>npm init vue@latest
![[../../../../../图片/Pasted image 20250224000316.png]]
### 最终
>我们这里先不引入Vue Router 和Pinia 到时候手动引入
![[../../../../../图片/Pasted image 20250224001510.png]]
## 查看项目
### 目录结构
![[../../../../../图片/Pasted image 20250224001856.png]]
...
![[../../../../../图片/Pasted image 20250224002933.png]]

#### tsconfig.node.json：为SSR考虑
![[../../../../../图片/Pasted image 20250224003351.png]]
## 项目配置
### 配置项目的icon
![[../../../../../图片/Pasted image 20250224011716.png]]
### 配置项目的标题
### 配置项目别名（Vite默认配置）
### 配置tsconfig.json
...
![[../../../../../图片/Pasted image 20250224125826.png]]
### 5、测试prettier是否有效
* 在代码中保存代码
* 配置一次性修改的命令
...
### 安装插件
![[../../../../../图片/Pasted image 20250224133058.png]]
### 配置ESLint
![[../../../../../图片/Pasted image 20250224133411.png]]
...
#### 创建CSS文件夹
![[../../../../../图片/Pasted image 20250224223934.png]]
#### 从网上找reset.less并粘贴进去
```
// reset.less
...
```
#### 在main.ts中引入
![[../../../../../图片/Pasted image 20250224224128.png]]
#### npm run dev 运行项目 发现报错
![[../../../../../图片/Pasted image 20250224224205.png]]
...
![[../../../../../图片/Pasted image 20250225002101.png]]
### 解决警告
![[../../../../../图片/Pasted image 20250225003449.png]]
```
...
![[../../../../../图片/Pasted image 20250225191320.png]]
...
```
## 配置路由
![[../../../../../图片/Pasted image 20250225194723.png]]
![[../../../../../图片/Pasted image 20250225194738.png]]
## pinia状态管理配置
### 安装pinia
>npm install pinia
...
### index.ts中导入并使用pinia
![[../../../../../图片/Pasted image 20250225195303.png]]
### main.ts中使用pinia
![[../../../../../图片/Pasted image 20250225195454.png]]
## axios网络请求的配置
### 在src文件夹下新建service文件夹，在service文件夹下新建config文件夹、modules文件夹、request文件夹
### 安装axios
>npm install axios
### 在config文件夹下新建index.ts文件
![[../../../../../图片/Pasted image 20250225204332.png]]
...
![[../../../../../图片/Pasted image 20250226124523.png]]
#### index.ts文件如下
```
...
![[../../../../../图片/Pasted image 20250226183216.png]]
#### 第二种方法
根据当前的环境去选择，但是编译器不知道production
![[../../../../../图片/Pasted image 20250226190746.png]]
#### Vite的环境变量
...
![[../../../../../图片/Pasted image 20250226191604.png]]
...
![[../../../../../图片/Pasted image 20250226193545.png]]
## ElementPlus的集成
### 安装ElementPlus
...
![[../../../../../图片/Pasted image 20250226203455.png]]
## App宽高铺满和ElementPlus的CSS
![[../../../../../图片/Pasted image 20250226214009.png]]
![[../../../../../图片/Pasted image 20250226214102.png]]
这样我们发现默认是没有占满屏幕的
![[../../../../../图片/Pasted image 20250226214402.png]]
即使App.vue中设置高度为100%也是不生效的
### 方法1：
![[../../../../../图片/Pasted image 20250226214715.png]]
![[../../../../../图片/Pasted image 20250226214733.png]]
### 方法2
![[../../../../../图片/Pasted image 20250226215801.png]]
## 登录页-Panel底部操作界面的搭建
### 引入背景图片
### 将登录的div封装成组件
...
```
效果：
![[../../../../../图片/Pasted image 20250227212026.png]]
## 图标的引入和使用
### 安装图标
>npm install @element-plus/icons-vue

### 注册图标
![[../../../../../图片/Pasted image 20250227213333.png]]
## 登录页-插槽的使用和tabs的切换绑定
![[../../../../../图片/Pasted image 20250227215717.png]]
最终代码
```
<template>
...
## 登录页-账号登录的验证规则配置
效果图：
![[../../../../../图片/Pasted image 20250228001346.png]]
```
<template>
...
#### 关键点
![[../../../../../图片/Pasted image 20250228001452.png]]
## 登录页-父组件点击logi调用子组件的方法

![[../../../../../图片/Pasted image 20250228125326.png]]
## 表单的验证和EIMessage样式
>在子组件中验证登录的逻辑，如果用户的输入不符合规则，不应该执行登录（不提交表单，不发送请求）
![[../../../../../图片/Pasted image 20250228131301.png]]

## 账号的登录逻辑和登录状态保存
模拟登录
>![[../../../../../图片/Pasted image 20250301130903.png]]

![[../../../../../图片/Pasted image 20250301130920.png]]
...
![[../../../../../图片/Pasted image 20250301131542.png]]

## 退出登录
>1.清除token  2.router.push('/login');(回到登录页)

![[../../../../../图片/Pasted image 20250301131654.png]]
## 登录页-记住密码
![[../../../../../图片/Pasted image 20250301142929.png]]
![[../../../../../图片/Pasted image 20250301142950.png]]
...
最终效果：
![[../../../../../图片/Pasted image 20250302092047.png]]
代码：
```
<template>
...
最终效果：
![[../../../../../图片/Pasted image 20250302094106.png]]
代码：
```
<template>
...
## main页面-手动搭建menu菜单展示
### el-menu 组件的解析
![[../../../../../图片/6f44d00ae6f1bb6dee6318e372182f1.jpg]]
## 搭建静态的菜单导航栏
### 最终效果
![[../../../../../图片/Pasted image 20250302113225.png]]
代码
```
<template>
...
```
### 最终效果：
![[../../../../../图片/Pasted image 20250302151003.png]]
### 问题 
>1、图标没有展示
>2、设置默认显示的菜单没成功
...
                            
```
![[../../../../../图片/Pasted image 20250302151720.png]]

## main页面-header头部的整体布局(静态布局的搭建)
### 最终效果：
![[../../../../../图片/Pasted image 20250302154221.png]]
### 代码：
```
<template>
...
```
## main页面-header图标点击折叠功能的实现
>子组件发生点击改变父组件
### 效果图
![[../../../../../图片/Pasted image 20250302232513.png]]
![[../../../../../图片/Pasted image 20250302232523.png]]
### 实现步骤：
#### 1、在main-header组件中记录点击的变化，来修改展示的图标，代码如下：
```
<template>
...
```
##### 核心代码解析
![[../../../../../图片/Pasted image 20250302233123.png]]
#### 处理侧边栏宽度
代码：
```
<template>
...
##### 核心代码解析
![[../../../../../图片/Pasted image 20250302233357.png]]
#### 折叠菜单
```
<template>
...
##### 核心代码解析
![[../../../../../图片/Pasted image 20250302233623.png]]
![[../../../../../图片/Pasted image 20250302233640.png]]
## main页面-header 个人信息展示和退出登录
```
<template>
...
export default router
```
![[../../../../../图片/Pasted image 20250304002828.png]]
...
#### 将路由对象写在独立的文件里
![[../../../../../图片/Pasted image 20250304213201.png]]
#### 根据菜单动态的添加路由对象
##### 1、获取菜单
