...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            pages: number;
            limits: number[];
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<PageProps>, {
            limit: number;
            pages: number;
            modelValue: number;
            showPage: boolean;
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<PageProps>, {
            limit: number;
            pages: number;
            modelValue: number;
            showPage: boolean;
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<PageProps>, {
        limit: number;
        pages: number;
        modelValue: number;
        showPage: boolean;
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<PageProps>, {
    limit: number;
    pages: number;
    modelValue: number;
    showPage: boolean;
