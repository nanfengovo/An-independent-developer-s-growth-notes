...
function toRef(...args) {
  ...
  const r = args[0];
  return typeof r === "function" ? vue.readonly(vue.customRef(() => ({ get: r, set: noop$2 }))) : vue.ref(r);
}
...
function parseEdge(edge, defaults = {}) {
  ...
  defaults = !isGraphEdge(edge) ? {
    ...
    data,
    events: vue.markRaw(events),
    label: (edge.label && typeof edge.label !== "string" ? vue.markRaw(edge.label) : edge.label) || defaults.label,
...
function useDrag(params) {
  ...
  vue.watch([() => toValue(disabled), el], ([isDisabled, nodeEl], _, onCleanup) => {
    if (nodeEl) {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ref_key: "handle",
        ref: handle,
        "data-id": `${vue.unref(nodeId)}-${vue.unref(handleId)}-${vue.unref(type)}`,
        "data-handleid": vue.unref(handleId),
        ...
        class: vue.normalizeClass(["vue-flow__handle", [
          ...
          `vue-flow__handle-${vue.unref(handleId)}`,
          vue.unref(noDragClassName),
          vue.unref(noPanClassName),
          vue.unref(type),
          {
            connectable: isConnectable.value,
            connecting: vue.unref(isClickConnecting),
            connectablestart: vue.unref(isConnectableStart),
            connectableend: vue.unref(isConnectableEnd),
            connectionindicator: isConnectable.value && (vue.unref(isConnectableStart) && !vue.unref(isConnecting) || vue.unref(isConnectableEnd) && vue.unref(isConnecting))
          }
        ]]),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("svg", null, [
        (vue.openBlock(), vue.createElementBlock("foreignObject", _hoisted_1$6, [
          (vue.openBlock(), vue.createBlock(vue.Teleport, {
            to: vue.unref(teleportTarget),
            disabled: !vue.unref(teleportTarget)
          }, [
            vue.renderSlot(_ctx.$slots, "default")
          ], 8, ["to", "disabled"]))
        ]))
...
function useKeyPress(keyFilter, onChange) {
  const window2 = useWindow();
  const isPressed = vue.ref(toValue(keyFilter) === true);
...
function useNode(id2) {
  const nodeId = id2 ?? vue.inject(NodeId, "");
...
function useViewport(state, getters) {
  const __$temp_1 = state, domNode = vue.toRef(__$temp_1, "vueFlowRef"), nodes = vue.toRef(__$temp_1, "nodes"), d3Zoom = vue.toRef(__$temp_1, "d3Zoom"), d3Selection = vue.toRef(__$temp_1, "d3Selection"), dimensions = vue.toRef(__$temp_1, "dimensions"), translateExtent = vue.toRef(__$temp_1, "translateExtent"), minZoom = vue.toRef(__$temp_1, "minZoom"), maxZoom = vue.toRef(__$temp_1, "maxZoom"), viewport = vue.toRef(__$temp_1, "viewport"), snapToGrid = vue.toRef(__$temp_1, "snapToGrid"), snapGrid = vue.toRef(__$temp_1, "snapGrid");
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.renderSlot(_ctx.$slots, "default"),
        vue.unref(userSelectionActive) && vue.unref(userSelectionRect) ? (vue.openBlock(), vue.createBlock(_sfc_main$a, {
          key: 0,
...
const _hoisted_1$1 = /* @__PURE__ */ vue.createElementVNode("div", { class: "vue-flow__edge-labels" }, null, -1);
const __default__$4 = {
  name: "Transform",
  compatConfig: { MODE: 3 }
};
const _sfc_main$4 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const viewportReady = vue.ref(!isClient);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        key: `transform-${vue.unref(id2)}`,
        class: "vue-flow__transformationpane vue-flow__container",
        style: vue.normalizeStyle({
          transform: `translate(${vue.unref(viewport).x}px,${vue.unref(viewport).y}px) scale(${vue.unref(viewport).zoom})`,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ref_key: "viewportRef",
        ref: viewportRef,
        key: `viewport-${vue.unref(id2)}`,
        class: "vue-flow__viewport vue-flow__container"
      }, [
        vue.createVNode(_sfc_main$9, {
          "is-selecting": vue.unref(isSelecting),
          class: vue.normalizeClass({ connecting: !!vue.unref(connectionStartHandle), dragging: vue.unref(paneDragging), draggable: vue.unref(shouldPanOnDrag) })
        }, {
          default: vue.withCtx(() => [
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        vue.createElementVNode("div", {
          ...
          style: { "display": "none" }
        }, " Press enter or space to select a node. " + vue.toDisplayString(!vue.unref(disableKeyboardA11y) ? "You can then use the arrow keys to move the node around." : "") + " You can then use the arrow keys to move the node around, press delete to remove it and press escape to cancel. ", 9, _hoisted_1),
        vue.createElementVNode("div", {
  ...
  setup(__props, { expose: __expose, emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createVNode(_sfc_main$3, null, {
          default: vue.withCtx(() => [
...
exports.EdgeLabelRenderer = _sfc_main$c;
exports.EdgeText = _sfc_main$e;
exports.ErrorCode = ErrorCode;
exports.GlobalVueFlowStorage = Storage;
