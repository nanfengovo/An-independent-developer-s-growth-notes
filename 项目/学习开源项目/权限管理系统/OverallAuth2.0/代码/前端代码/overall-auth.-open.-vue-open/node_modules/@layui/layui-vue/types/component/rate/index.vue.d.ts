...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            clearIcon: string;
            icons: string[];
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<RateProps>, {
            length: number;
            modelValue: number;
            readonly: boolean;
            half: boolean;
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<RateProps>, {
            length: number;
            modelValue: number;
            readonly: boolean;
            half: boolean;
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<RateProps>, {
        length: number;
        modelValue: number;
        readonly: boolean;
        half: boolean;
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<RateProps>, {
    length: number;
    modelValue: number;
    readonly: boolean;
    half: boolean;
