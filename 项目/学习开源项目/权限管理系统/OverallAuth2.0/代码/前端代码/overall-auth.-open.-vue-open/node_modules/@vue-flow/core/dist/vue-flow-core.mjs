import { toRef as toRef$1, readonly, customRef, ref, getCurrentScope, onScopeDispose, unref, isRef, toRefs as toRefs$1, watch, computed, getCurrentInstance, nextTick, onMounted, markRaw, defineComponent, createPropsRestProxy, onUnmounted, openBlock, createElementBlock, normalizeClass, renderSlot, h, provide, onBeforeUnmount, normalizeStyle, createCommentVNode, createElementVNode, mergeProps, createBlock, resolveDynamicComponent, Fragment, createTextVNode, toDisplayString, useAttrs, Teleport, inject, onBeforeMount, reactive, effectScope, renderList, resolveComponent, createVNode, withCtx, useSlots } from "vue";
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "handle",
        ref: handle,
        "data-id": `${unref(nodeId)}-${unref(handleId)}-${unref(type)}`,
        "data-handleid": unref(handleId),
        "data-nodeid": unref(nodeId),
        "data-handlepos": _ctx.position,
        class: normalizeClass(["vue-flow__handle", [
          `vue-flow__handle-${_ctx.position}`,
          `vue-flow__handle-${unref(handleId)}`,
          unref(noDragClassName),
          unref(noPanClassName),
          unref(type),
          {
            connectable: isConnectable.value,
            connecting: unref(isClickConnecting),
            connectablestart: unref(isConnectableStart),
            connectableend: unref(isConnectableEnd),
            connectionindicator: isConnectable.value && (unref(isConnectableStart) && !unref(isConnecting) || unref(isConnectableEnd) && unref(isConnecting))
          }
        ]]),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", null, [
        (openBlock(), createElementBlock("foreignObject", _hoisted_1$6, [
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...__default__$b,
  setup(__props) {
    const __$temp_1 = useVueFlow(), emits = toRef$1(__$temp_1, "emits"), viewport = toRef$1(__$temp_1, "viewport"), getSelectedNodes = toRef$1(__$temp_1, "getSelectedNodes"), noPanClassName = toRef$1(__$temp_1, "noPanClassName"), disableKeyboardA11y = toRef$1(__$temp_1, "disableKeyboardA11y"), userSelectionActive = toRef$1(__$temp_1, "userSelectionActive");
    ...
    return (_ctx, _cache) => {
      return !userSelectionActive.value && selectedNodesBBox.value.width && selectedNodesBBox.value.height ? (openBlock(), createElementBlock("div", {
        key: 0,
...
function useActions(id2, emits, hooksOn, state, getters, nodeIds, edgeIds) {
  ...
  const updateNodeDimensions = (updates) => {
    ...
    let zoom2;
    if ((_a = state.__experimentalFeatures) == null ? void 0 : _a.nestedFlow) {
  ...
  const fromObject = (obj) => {
    return new Promise((resolve) => {
      ...
      if ((viewport == null ? void 0 : viewport.x) && (viewport == null ? void 0 : viewport.y) || position) {
        ...
        return until(() => viewportHelper.value.initialized).toBe(true).then(() => {
  ...
  until(() => viewportHelper.value.initialized).toBe(true).then(async () => {
...
function useGetters(state, nodeIds, edgeIds) {
  ...
  const getEdgeTypes = computed(() => {
    ...
    (_a = state.edges) == null ? void 0 : _a.forEach((e) => e.type && !keys.includes(e.type) && (edgeTypes[e.type] = e.type));
    return edgeTypes;
  });
  const getNodeTypes = computed(() => {
    ...
    (_a = state.nodes) == null ? void 0 : _a.forEach((n) => n.type && !keys.includes(n.type) && (nodeTypes[n.type] = n.type));
    return nodeTypes;
  });
...
function useNode(id2) {
  const nodeId = id2 ?? inject(NodeId, "");
...
function useViewport(state, getters) {
  const __$temp_1 = state, domNode = toRef$1(__$temp_1, "vueFlowRef"), nodes = toRef$1(__$temp_1, "nodes"), d3Zoom = toRef$1(__$temp_1, "d3Zoom"), d3Selection = toRef$1(__$temp_1, "d3Selection"), dimensions = toRef$1(__$temp_1, "dimensions"), translateExtent = toRef$1(__$temp_1, "translateExtent"), minZoom = toRef$1(__$temp_1, "minZoom"), maxZoom = toRef$1(__$temp_1, "maxZoom"), viewport = toRef$1(__$temp_1, "viewport"), snapToGrid = toRef$1(__$temp_1, "snapToGrid"), snapGrid = toRef$1(__$temp_1, "snapGrid");
  const { getNodes } = getters;
  const isReady = ref(false);
  until(() => !!d3Zoom.value && !!d3Selection.value && !!dimensions.value.width && !!dimensions.value.height).toBe(true).then(() => {
    isReady.value = true;
  });
...
function useZoomPanHelper(vueFlowId) {
  ...
  const viewportHelper = useViewport(state.value, state.value);
  return {
    fitView: (params) => viewportHelper.value.fitView(params),
    zoomIn: (transitionOpts) => viewportHelper.value.zoomIn(transitionOpts),
    zoomOut: (transitionOpts) => viewportHelper.value.zoomOut(transitionOpts),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        renderSlot(_ctx.$slots, "default"),
        unref(userSelectionActive) && unref(userSelectionRect) ? (openBlock(), createBlock(_sfc_main$a, {
          key: 0,
...
const _hoisted_1$4 = { class: "vue-flow__nodes vue-flow__container" };
const __default__$8 = {
  name: "Nodes",
  compatConfig: { MODE: 3 }
};
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    until(() => areNodesInitialized.value).toBe(true).then(() => {
      nextTick(() => {
...
const _hoisted_1$3 = ["id", "markerWidth", "markerHeight", "markerUnits", "orient"];
const __default__$7 = {
  name: "MarkerType",
  compatConfig: { MODE: 3 }
};
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...__default__$6,
  setup(__props) {
    const __$temp_1 = useVueFlow(), vueFlowId = toRef$1(__$temp_1, "id"), edges = toRef$1(__$temp_1, "edges"), connectionLineOptions = toRef$1(__$temp_1, "connectionLineOptions"), defaultColor = toRef$1(__$temp_1, "defaultMarkerColor");
...
const _hoisted_1$2 = { class: "vue-flow__edges vue-flow__container" };
const __default__$5 = {
  name: "Edges",
  compatConfig: { MODE: 3 }
};
...
const _hoisted_1$1 = /* @__PURE__ */ createElementVNode("div", { class: "vue-flow__edge-labels" }, null, -1);
const __default__$4 = {
  name: "Transform",
  compatConfig: { MODE: 3 }
};
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    until(() => !!(d3Zoom.value && d3Selection.value && dimensions.value.width > 0 && dimensions.value.height > 0)).toBe(true).then(() => {
      setTimeout(() => {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useEventListener(window2, "resize", setDimensions);
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "viewportRef",
        ref: viewportRef,
        key: `viewport-${unref(id2)}`,
        class: "vue-flow__viewport vue-flow__container"
      }, [
        createVNode(_sfc_main$9, {
          "is-selecting": unref(isSelecting),
          class: normalizeClass({ connecting: !!unref(connectionStartHandle), dragging: unref(paneDragging), draggable: unref(shouldPanOnDrag) })
        }, {
          default: withCtx(() => [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createElementVNode("div", {
          ...
          style: { "display": "none" }
        }, " Press enter or space to select a node. " + toDisplayString(!unref(disableKeyboardA11y) ? "You can then use the arrow keys to move the node around." : "") + " You can then use the arrow keys to move the node around, press delete to remove it and press escape to cancel. ", 9, _hoisted_1),
        createElementVNode("div", {
...
export {
  ...
  ConnectionLineType,
  ConnectionMode,
  _sfc_main$c as EdgeLabelRenderer,
